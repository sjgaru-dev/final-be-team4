...
public class VCService_team_multi {
    ...
    public VCProjectResDto getVCProjectDto(Long projectId) {
        ...
        String trgAudio = "";
        if(vcPrjDto.getMemberTargetAudioMetaId() != null){
            MemberAudioMeta memberAudioMeta = memberAudioMetaRepository.findById(vcPrjDto.getMemberTargetAudioMetaId())
                    .orElseThrow(() -> new BusinessException(ErrorCode.AUDIO_NOT_FOUND_EXCEPTION));

            trgAudio = memberAudioMeta.getAudioUrl();
        }
